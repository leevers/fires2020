define([
  ...
  var RL = Layer.createSubclass({
    ...
    _setView: function(view, container) {
      this._view = view;
      ...
      this._mapWidth = view.width;
      this._mapHeight = view.height;
      
      // Event connections
      this._connects = [];
      this._connects.push(connect.connect(view, "onPan", this, this._panHandler));
      this._connects.push(connect.connect(view, "onExtentChange", this, this._extentChangeHandler));
      this._connects.push(connect.connect(view, "onZoomStart", this, this.clear));
    ...
    _visibilityChangeHandler: function(visible) {
      if (visible) {
        jQuery.show(this._element);
      }
      else { 
        jQuery.hide(this._element);
      }
    }
